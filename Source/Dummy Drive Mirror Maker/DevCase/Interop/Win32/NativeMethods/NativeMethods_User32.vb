...
#Region " User32.dll "
        ...
        Public Shared Function GetClassName(hwnd As IntPtr,
...
maxCount As Integer
        ...
        <DllImport("User32.dll", EntryPoint:="DestroyWindow", SetLastError:=True,
                   CallingConvention:=CallingConvention.StdCall)>
        Public Shared Function DestroyWindow(hwnd As HandleRef
        ) As IntPtr
        End Function
...
uFlags As SetWindowPosFlags
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function SetWindowPos(hwnd As HandleRef,
hwndInsertAfter As IntPtr,
x As Integer,
y As Integer,
cx As Integer,
...
uFlags As SetWindowPosFlags
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function GetWindowRect(hwnd As HandleRef,
                                       <Out> ByRef refRect As NativeRectangle
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", CharSet:=CharSet.Auto, SetLastError:=True, BestFitMapping:=False, ThrowOnUnmappableChar:=True)>
        Public Shared Function GetClassName(hwnd As HandleRef,
className As StringBuilder,
maxCount As Integer
        ) As Integer
        End Function
        ...
        Public Shared Function GetDlgItem(hwnd As IntPtr,
index As Integer
        ) As IntPtr
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("user32.dll", SetLastError:=False)>
        Public Shared Function GetDlgItem(hwnd As HandleRef,
index As Integer
        ) As IntPtr
        End Function
        ...
        Public Shared Function BeginPaint(hwnd As IntPtr,
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("user32.dll", CharSet:=CharSet.Auto, ExactSpelling:=False)>
        Public Shared Function BeginPaint(hwnd As HandleRef,
                             <[In]> <Out> ByRef refPaint As PaintStruct
        ) As IntPtr
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("user32.dll", CharSet:=CharSet.Auto, ExactSpelling:=False)>
        Public Shared Function EndPaint(hwnd As HandleRef,
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("user32.dll", CharSet:=CharSet.Auto, ExactSpelling:=False)>
        Public Shared Function EndPaint(hwnd As IntPtr,
                                        ByRef refPaint As PaintStruct
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("User32.dll", SetLastError:=True)>
        Public Shared Function EnumThreadWindows(dwThreadId As UInteger,
