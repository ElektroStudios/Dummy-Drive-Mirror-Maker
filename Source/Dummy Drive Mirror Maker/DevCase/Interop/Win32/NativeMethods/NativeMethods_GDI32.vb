...
#Region " GDI32.dll "
        ...
        Public Shared Function GetTextMetricsA(hdc As IntPtr,
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("GDI32.dll", CharSet:=CharSet.Ansi, ExactSpelling:=False)>
        Public Shared Function GetTextMetricsA(hdc As HandleRef,
                                               ByRef refMetrics As TextMetricA
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        Public Shared Function GetTextMetricsW(hdc As IntPtr,
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("GDI32.dll", CharSet:=CharSet.Unicode, ExactSpelling:=False)>
        Public Shared Function GetTextMetricsW(hdc As HandleRef,
                                               ByRef refMetrics As TextMetricW
        ) As <MarshalAs(UnmanagedType.Bool)> Boolean
        End Function
        ...
        Public Shared Function SelectObject(hdc As IntPtr,
hObject As IntPtr
        ) As IntPtr
        End Function
        ...
        <SuppressUnmanagedCodeSecurity>
        <DllImport("GDI32.dll", CharSet:=CharSet.Auto, ExactSpelling:=False)>
        Public Shared Function SelectObject(hdc As HandleRef,
