...
#Region " Kernel32.dll "
        ...
        Public Shared Function CreateSymbolicLink(dstPath As String,
srcPath As String,
                    <MarshalAs(UnmanagedType.I4)> flags As SymbolicLinkFlags
...
overlapped As IntPtr
        ...
        Public Shared Function CreateFile(<MarshalAs(UnmanagedType.LPTStr)> filepath As String,
                                          <MarshalAs(UnmanagedType.U4)> access As FileAccessRights,
                                          <MarshalAs(UnmanagedType.U4)> share As FileShare,
                                          <MarshalAs(UnmanagedType.SysInt)> securityAttributes As IntPtr,
                                          <MarshalAs(UnmanagedType.U4)> creationDisposition As FileMode,
                                          <MarshalAs(UnmanagedType.U4)> flagsAndAttributes As UInteger,
                                          <MarshalAs(UnmanagedType.SysInt)> templateFile As IntPtr
        ) As SafeFileHandle
        End Function
