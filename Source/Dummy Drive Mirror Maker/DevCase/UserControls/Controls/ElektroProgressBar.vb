...
Imports DevCase.UserControls.Enums
Imports DevCase.UserControls.Types
Imports DevCase.UserControls.Types.Designers
Imports DevCase.UserControls.Types.EventArgs
...
#Region " Properties "
        ...
        Public ReadOnly Property Percentage As Double
            Get
                Dim value As Double = MyBase.Value / MyBase.Maximum * 100 '((MyBase.Value - MyBase.Minimum) / (MyBase.Maximum - MyBase.Minimum)) * 100
...
#Region " Events "
        ...
        Public Custom Event ValueChanged As EventHandler(Of ProgressBarValueChangedEventArgs)
            ...
            <DebuggerNonUserCode>
            <DebuggerStepThrough>
            AddHandler(value As EventHandler(Of ProgressBarValueChangedEventArgs))
                MyBase.Events.AddHandler("ValueChangedEvent", value)
            End AddHandler

            <DebuggerNonUserCode>
            <DebuggerStepThrough>
            RemoveHandler(value As EventHandler(Of ProgressBarValueChangedEventArgs))
                MyBase.Events.RemoveHandler("ValueChangedEvent", value)
            End RemoveHandler

            <DebuggerNonUserCode>
            <DebuggerStepThrough>
            RaiseEvent(sender As Object, e As ProgressBarValueChangedEventArgs)
...
#Region " Event Invocators "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Protected Overridable Sub OnValueChanged(e As ProgressBarValueChangedEventArgs)
...
#Region " Public Methods "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Overridable Shadows Sub Increment(value As Integer)
