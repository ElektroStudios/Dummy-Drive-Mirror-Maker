...
#Region " Public Methods "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Sub CreateSymbolicLink(ByVal srcFile As FileInfo, ByVal dstDir As DirectoryInfo)
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Sub CreateSymbolicLink(ByVal srcFile As FileInfo, ByVal dstDirPath As String)
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Sub CreateSymbolicLink(ByVal srcFilePath As String, ByVal dstDirPath As DirectoryInfo)
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Sub CreateSymbolicLink(ByVal srcFilePath As String, ByVal dstDirPath As String)
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Function IsSymbolicLink(ByVal file As FileInfo) As Boolean
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Function IsSymbolicLink(ByVal filePath As String) As Boolean
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Function GetSymbolicLinkTarget(ByVal file As FileInfo) As FileInfo
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Public Shared Function GetSymbolicLinkTarget(ByVal filePath As String) As String
...
#Region " Private Methods "
        ...
        ''' ----------------------------------------------------------------------------------------------------
        <DebuggerStepThrough>
        Private Shared Function IsReparsePointOf(ByVal filePath As String, ByVal tag As ReparsePointTags) As Boolean
